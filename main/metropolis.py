...
class MHAlgorithm:
    """General purpose Metropolis-Hastings algorithm class for sampling from a target distribution.

    This class is designed to be subclassed to implement specific target distributions and proposal distributions.
    The step method must be implemented in the subclass to define the proposal distribution.
    The log_density method must be implemented in the subclass to define the target distribution.
